...
export default function ShaderBackground({
  ...
  useEffect(() => {
    ...
    const shaderBundle = createShaderProgram(
      gl,
      vertexShaderSource,
    ...
    const { program, vertexShader, fragmentShader } = shaderBundle;
    ...
    if (vertexPosition < 0 || !resolution || !time) {
    ...
    const resizeCanvas = () => {
      ...
      // Cap the pixel ratio so the shader stays smooth without becoming too
      // expensive on high-density mobile screens.
